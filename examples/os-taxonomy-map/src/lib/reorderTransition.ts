// FLIP-style vertical settling for the article's reorder path. Callers
// measure the old and new tops; this helper applies the inverse offset,
// then lets CSS transition it to 0.
